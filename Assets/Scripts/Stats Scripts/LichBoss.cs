...
public class LichBoss : MonoBehaviour {
    ...
    public static float baseDefModifer = 3.5f;
    ...
    public static float defModifer = 3.5f;
    ...
    public static float defCap = 30;
    public static float skillCap = 20;
    public static float spdCap = 15;
    public static float magicCap = 25;
    public static float willCap = 25;
