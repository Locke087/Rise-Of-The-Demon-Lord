...
public class Cavalier : MonoBehaviour {
    ...
    public static double[] STRgrowth = { };
    public static double[] DEFgrowth = { };
    public static double[] SKILLgrowth = { };
    public static double[] SPDgrowth = { };
    public static double[] MAGgrowth = { };
    public static double[] WILLgrowth = { };
