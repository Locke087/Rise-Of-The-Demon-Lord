...
public class Dread : MonoBehaviour {
    ...
    public static float baseMagicModifer = 3;
    public static float baseWillModifer = 3;
    ...
    public static float magicModifer = 3;
    public static float willModifer = 3;
    public static float strCap = 12;
    public static float defCap = 18;
    public static float skillCap = 13;
    public static float spdCap = 13;
    public static float magicCap = 27;
    public static float willCap = 27;
