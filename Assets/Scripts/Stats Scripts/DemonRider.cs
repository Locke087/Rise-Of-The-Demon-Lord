...
public class DemonRider : MonoBehaviour {
    ...
    public static float baseSpdModifer = 3.5f;
    ...
    public static float spdModifer = 3.5f;
    public static float magicModifer = 3;
    public static float willModifer = 2;
    public static float strCap = 22;
    public static float defCap = 23;
    public static float skillCap = 27;
    public static float spdCap = 30;
    public static float magicCap = 22;
    public static float willCap = 13;
