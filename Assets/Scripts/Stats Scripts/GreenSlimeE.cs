...
public class GreenSlimeE : MonoBehaviour {
    ...
    public static float baseStrModifer = 2;
    public static float baseDefModifer = 2;
    public static float baseSkillModifer = 2;
    public static float baseSpdModifer = 2;
    public static float baseMagicModifer = 2;
    public static float baseWillModifer = 2.5f;
    public static float strModifer = 2;
    public static float defModifer = 2;
    public static float skillModifer = 2;
    public static float spdModifer = 2;
    public static float magicModifer = 2;
    public static float willModifer = 2.5f;
    public static float strCap = 12;
    public static float defCap = 12;
    public static float skillCap = 12;
    public static float spdCap = 12;
    public static float magicCap = 12;
    public static float willCap = 18;
    public static float hpCap = 15;
