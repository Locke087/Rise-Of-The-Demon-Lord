...
public class DarkKnight : MonoBehaviour {
    ...
    public static float baseStrModifer = 2.5f;
    public static float baseDefModifer = 3;
    public static float baseSkillModifer = 2;
    public static float baseSpdModifer = 2;
    public static float baseMagicModifer = 3.5f;
    public static float baseWillModifer = 3.5f;
    public static float strModifer = 2.5f;
    public static float defModifer = 2.5f;
    public static float skillModifer = 2;
    public static float spdModifer = 2;
    public static float magicModifer = 3.5f;
    public static float willModifer = 3.5f;
    public static float strCap = 20;
    public static float defCap = 26;
    public static float skillCap = 18;
    public static float spdCap = 18;
    public static float magicCap = 28;
    public static float willCap = 28;
    public static float hpCap = 50;
