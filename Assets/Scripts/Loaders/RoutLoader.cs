...
public class RoutLoader : MonoBehaviour {
    ...
    public void RiptoMapFromMemory()
    {
        ...
        if(og) list = CurrentGame.game.overGrown.rout.allAreas.areaDirectors;
        if (sw) list = CurrentGame.game.scorchingWastes.rout.allAreas.areaDirectors;
        if (gd) list = CurrentGame.game.growlingDeeps.rout.allAreas.areaDirectors;
        if (ft) list = CurrentGame.game.frozenTundra.rout.allAreas.areaDirectors;
        organizer.StartUp();
        do
        {
