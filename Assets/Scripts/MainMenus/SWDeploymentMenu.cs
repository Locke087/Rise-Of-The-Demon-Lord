...
public class SWDeploymentMenu : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        GUILayout.FlexibleSpace();
        GUILayout.Box("The Scorching Wastes");
        GUILayout.FlexibleSpace();
        ...
        if (currentMenu == Menu.LevelMenu)
        {
            ...
            GUILayout.Space(10);
            foreach (CurrentLevel level in CurrentGame.game.memoryGeneral.levelHolder.swLevels.currentLevels)
            {
                if (!level.complete)
                {
