...
public class GDDeploymentMenu : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        GUILayout.FlexibleSpace();
        GUILayout.Box("The Growling Deeps");
        GUILayout.FlexibleSpace();
        ...
        if (currentMenu == Menu.LevelMenu)
        {
            ...
            GUILayout.Space(10);
            foreach (CurrentLevel level in CurrentGame.game.memoryGeneral.levelHolder.gdLevels.currentLevels)
            {
                if (!level.complete)
                {
