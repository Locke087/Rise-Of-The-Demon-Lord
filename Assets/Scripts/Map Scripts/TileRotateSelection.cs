...
public class TileRotateSelection : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    public TextMeshProUGUI textMeshPro;
    public int linkIndex = 0;
    public int linkIndexOld = 0;
    public Camera camera;
    public string ex = "<link='test'>Hello</link>";
    ...
    void Start()
    {
        ...
        textMeshPro.text += "\n";
        textMeshPro.text += "<link=SEorS>Down Right or Down</link>";
        textMeshPro.text += "\n";
        textMeshPro.text += "<link=SWorW>Down Left or Left</link>";
        textMeshPro.text += "\n";
    ...
    {
        GameObject.FindObjectOfType<MiddleManStorage>().AssignRotate(pick, display);
    }
